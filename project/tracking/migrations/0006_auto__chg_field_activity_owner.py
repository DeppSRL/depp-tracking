...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'tracking_activity', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['tracking.Employee']))

    def backwards(self, orm):

        # Changing field 'Activity.owner'
        db.alter_column(u'tracking_activity', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['tracking.Employee']))
    ...
    models = {
        ...
        u'tracking.activity': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'own_activities'", 'to': u"orm['tracking.Employee']"}),
