...
PROJECT_NAME = "depp-tracking-project" or PACKAGE_NAME
PROJECT_PACKAGE = "tracking" or PACKAGE_NAME

REPO_PATH = dirname(PROJECT_PATH)
REPO_NAME = "depp-tracking" or basename(REPO_PATH)
...
SECRET_KEY = r"hr32kv_-b(ex6#p2++#($zsz(z%c$(sh))z!i5o1@%carp%ci0"
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': normpath(join(RESOURCES_PATH, 'logs', 'tracking.log')),
            'formatter': 'verbose'
        },
    },
    'loggers': {
...
PAST_WEEKS_IN_SELECT = 7
PAST_WEEKS_IN_REPORTS = 8
LOGIN_URL = "/admin"
